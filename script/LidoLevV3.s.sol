...
import {LidoLevEthStrategy} from "src/strategies/deployed/LidoLevEthStrategy.sol";
...
contract Deploy is Script {
    ...
    function lidoLevEth() external {
        _start();

        Vault vault = Vault(0x1196B60c9ceFBF02C9a3960883213f47257BecdB); // Lev eth vault
        address[] memory strategists = new address[](1);
        strategists[0] = 0x47fD0834DD8b435BbbD7115bB7d3b3120dD0946d;

        LidoLevEthStrategy strategy = new LidoLevEthStrategy(AffineVault(address(vault)), strategists);
