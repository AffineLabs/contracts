...
export async function deployContractRegistry(
  ...
  const L1ContractRegistryFactory: ContractFactory = await ethers.getContractFactory('ContractRegistry');
  ...
  const L2ContractRegistryFactory: ContractFactory = await ethers.getContractFactory('ContractRegistry');
