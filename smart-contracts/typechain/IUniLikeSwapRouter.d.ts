...
interface IUniLikeSwapRouterInterface extends ethers.utils.Interface {
  functions: {
...
export class IUniLikeSwapRouter extends BaseContract {
  ...
  interface: IUniLikeSwapRouterInterface;
