...
interface L2AAVEStrategyInterface extends ethers.utils.Interface {
  functions: {
    "aToken()": FunctionFragment;
    "debtThreshold()": FunctionFragment;
    "estimatedRewardsInWant()": FunctionFragment;
    ...
    "minRewardToSell()": FunctionFragment;
    "minWant()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "estimatedRewardsInWant",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "minRewardToSell",
    values?: undefined
  ): string;
  encodeFunctionData(functionFragment: "minWant", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "minWant", data: BytesLike): Result;
...
export class L2AAVEStrategy extends BaseContract {
  ...
  functions: {
    ...
    estimatedRewardsInWant(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    minRewardToSell(overrides?: CallOverrides): Promise<[BigNumber]>;

    minWant(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    minRewardToSell(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    minWant(overrides?: CallOverrides): Promise<PopulatedTransaction>;
