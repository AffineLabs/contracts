...
contract AffineDelegator is Initializable, AffineGovernable {
    ...
    IDelegationManager public immutable delegationManager = IDelegationManager(0x39053D51B77DC0d36036Fc1fCc8Cb819df8Ef37A); // DelegationManager for Eigenlayer
    ...
    modifier onlyHarvester() {
        require(
            vault.hasRole(vault.HARVESTER(), msg.sender) || msg.sender == governance,
