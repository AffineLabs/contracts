...
import {ProfitReserveVaultV2, MathUpgradeable, SafeTransferLib, ERC20} from "src/vaults/ProfitReserveVaultV2.sol";
import {IWETH} from "src/interfaces/IWETH.sol";

/// @notice The same as Vault, but ONLY raw ether can be withdrawn.
contract ProfitReserveEthVaultV2 is ProfitReserveVaultV2 {
